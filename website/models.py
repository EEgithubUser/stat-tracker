...
class StatSnapshot(db.Model):
    ...
    pts_snapshot = db.Column(db.Integer)
    rbs_snapshot = db.Column(db.Integer)
    asts_snapshot = db.Column(db.Integer)
    stls_snapshot = db.Column(db.Integer)
    tos_snapshot = db.Column(db.Integer)
    blks_snapshot = db.Column(db.Integer)
    mins_snapshot = db.Column(db.Integer)
    date_snapshot = db.Column(db.DateTime(timezone=True), default=func.now())
